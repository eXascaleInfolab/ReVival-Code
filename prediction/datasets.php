...
$query = "
        ...
        FROM
            sets 
        WHERE sets.modified = FALSE AND (sets.id = 17 OR sets.id = 19 OR sets.id = 5 OR sets.id = 6)
...
<div class="container">
    ...
    <p>To predict a dataset, click on its title from the table below.</p>

    <h3>Datasets to perform predictions</h3>
    <p>These datasets have no missing values. Users can run predictions on multiple time series.</p>
    <table class="table">
        <tr>
            <th>Title</th>
            <th>Source</th>
